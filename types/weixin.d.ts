declare namespace WeixinJsSdk {
  ...
  interface updateAppMessageShareOptions extends OnMenuShareTimelineOptions {
    /**
     * 分享描述
     */
    desc?: string;
  }
  interface updateTimelineShareOptions extends OnMenuShareTimelineOptions {
    /**
     * 分享描述
     */
    desc?: string;
  ...
  function updateAppMessageShareData(
    options: updateAppMessageShareOptions
  ): void;

  /**
   * 自定义“分享到朋友圈”及“分享到 QQ 空间”按钮的分享内容
   */
  function updateTimelineShareData(options: updateTimelineShareOptions): void;
